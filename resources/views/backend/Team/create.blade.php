            ...
            <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                <div class="d-md-flex">
                    <ol class="breadcrumb ms-auto">
                        <li><a href="#" class="fw-normal">Dasboard > Team > Create</a></li>
                    </ol>
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="white-box col-md-6 mx-auto">
                    <h3 class="box-title">New Team Mmber</h3>
                    <div class="table-responsive">
                        <table class="table text-nowrap">
                            <form action="{{route('tm.store')}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Team Member Name</label>
                                    <input type="text" class="form-control" id="name" aria-describedby="emailHelp"
                                        name="name" placeholder="Enter Team member name" required>
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="des" aria-describedby="emailHelp"
                                        name="des" placeholder="Enter Team member designation" required>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputEmail1">Team Member Email</label>
                                    <input type="email" class="form-control" id="email" aria-describedby="emailHelp"
                                        name="email" placeholder="Enter Team member Email" required>
                                </div>
                                <div class="form-group">
                                    <label for="slider">Team Member Image</label><br />
                                    <p>* For Best Quality image size should be 600X600 </p>
